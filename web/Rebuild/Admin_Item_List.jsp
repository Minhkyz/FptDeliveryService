...
<head>
    <link rel="stylesheet" href="set="UTF-8">
                            ...
                            <div class="overflow-x">
                                <table style="width: 100%;" id="filtertable" class="table cust-datatable dataTable no-footer">
                                    ...
                                    <tr>
                                        ...
                                        <th style="min-width: 100px;">ShortDescript</th>
                                        <th style="min-width: 90px;">Price</th>
                                        <th style="min-width: 260px;">FullDescript</th>
                                    ...
                                    <tr>
                                        <td>Bánh mì chả</td>
                                        <td>Ngon, thơm, rẻ</td>
                                        <td ><span class="mode mode_process">15.000</span></td>
                                        <td>Món này trước cổng DDH FPT nha mn!!</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Ngon, thơm, rẻ</td>
                                        <td ><span class="mode mode_process">15.000</span></td>
                                        <td style="transform: translateX(120px);">Món này trước cổng DDH FPT nha mn!!</td>
...
<script src="./js/item_table.js"></script>
<!--Close table-->
</body>
