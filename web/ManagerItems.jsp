        ...
        <table class="table table-striped table-hover">
            ...
            <c:forEach items="${listP}" var="o">
                <tr>
                    ...
                    <td>
                        <a href="EditItemsControl?id=${o.id}" class="Update" data-toggle="modal"><i class="material-icons"
                                                                                                  data-toggle="tooltip"title="Update">&#xE254;</i>
                        </a>
                        <a href="#" onclick="showMess(${o.id})" class="Delete" data-toggle="modal" >
                            <i
        ...
        <div class="modal-content">
            <form action="AddItemsControl" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Price</label>
                        <input name="price" type="text" pattern="\d*" class="form-control" required>
                    </div>
...
<script>
    function showMess(id){
        ...
        if(option === true){
            window.location.href = 'DeleteItemsControl?id='+id;
        }
    }
</script>
</body>
